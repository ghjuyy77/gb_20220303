...
public class Main09 {
	...
	public static void main(String[] args) {
		 ...
		 *  문제5-2 국어점수가 70점 이상이면 "국어합격" 그렇지 않으면 " 국어 불합격"을 출력하여라.
		 *  문제5-3 수학점수가 90점 이상이면 "A학점", 80점 이상이면"B"학점, 70점 이상이면 "c"학점,
		 *  60점 이상이면 "D", 나머지 "F학점" 을 출
		 */
		int kor = 100, eng = 95, mat = 90;
		...
		int num = 1;
				...
				default:System.out.println("배드민턴");
					break;
				}
